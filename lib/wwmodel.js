...
function postReady(d,props={}) {
  ...
  Lo.forEach( a => a.parent.forEach( b => links.push( [a.id,b.id] ) ) );
  Ls.forEach( a => a.parent.forEach( b => links.push( [a.id,b.id] ) ) );
  Lc.forEach( a => a.parent.forEach( b => links.push( [a.id,b.id] ) ) );
  Ll.forEach( a => {
    a.parent.forEach( b => links.push( [a.id,b.id] ) );
    coords.push( a.coord );
    stats.push( [...a.stat] );
